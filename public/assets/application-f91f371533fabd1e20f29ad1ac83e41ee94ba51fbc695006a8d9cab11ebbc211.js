...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [0, 50000, 5000, 15000, 10000, 20000, 15000, 25000, 20000, 30000, 25000, 100000, 50, 60000],
    }],
  },
  options: {
...
var hours = gon.distribution;
var ctx = document.getElementById("HourDistributionChart");
var myPieChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      data: hours,
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#5d98f2'],
